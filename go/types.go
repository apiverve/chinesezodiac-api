// Package chinesezodiac provides a Go client for the Chinese Zodiac API.
//
// For more information, visit: https://apiverve.com/marketplace/chinesezodiac?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Chinese Zodiac API.
//
// Parameters:
//   - date (required): string - The date in YYYY-MM-DD format (years 1900-2100) [format: date]
type Request struct {
...
// ResponseData contains the data returned by the Chinese Zodiac API.
type ResponseData struct {
	Date string `json:"date"`
	ZodiacYear int `json:"zodiacYear"`
	Animal string `json:"animal"`
	AnimalChinese string `json:"animalChinese"`
	Element string `json:"element"`
	ElementChinese string `json:"elementChinese"`
	ElementColor string `json:"elementColor"`
	Polarity string `json:"polarity"`
	Traits []string `json:"traits"`
	SexagenaryCyclePosition int `json:"sexagenaryCyclePosition"`
	FullName string `json:"fullName"`
	ChineseNewYear string `json:"chineseNewYear"`
}
