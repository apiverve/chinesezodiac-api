...
const (
	baseURL        = "https://api.apiverve.com/v1/chinesezodiac"
	defaultTimeout = 30 * time.Second
)

// Client is the Chinese Zodiac API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Chinese Zodiac API client.
...
// Execute makes a request to the Chinese Zodiac API with typed parameters.
//
