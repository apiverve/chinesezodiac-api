...
namespace APIVerve\Chinesezodiac;
...
/**
 * Client for the Chinese Zodiac API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/chinesezodiac?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/chinesezodiac';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\ChinesezodiacClient] {$message}\n";
        }
    }
}
