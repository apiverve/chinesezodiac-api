...
namespace APIVerve.API.ChineseZodiac
{
    ...
    /// <summary>
    /// Client for the ChineseZodiac API
    /// </summary>
    public class ChineseZodiacAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/chinesezodiac";
        ...
        public ChineseZodiacAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ChineseZodiacAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ChineseZodiacAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, ChineseZodiacQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(ChineseZodiacQueryOptions options)
        {
        ...
        public ResponseObj Execute(ChineseZodiacQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ChineseZodiacQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ChineseZodiacQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ChineseZodiacQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ChineseZodiacQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ChineseZodiacQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(ChineseZodiacQueryOptions options)
        {
