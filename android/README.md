...
```gradle
dependencies {
    implementation 'com.github.apiverve:chinesezodiac-api:1.1.13'
}
```
...
```java
import com.apiverve.chinesezodiac.ChineseZodiacAPIClient;
import com.apiverve.chinesezodiac.APIResponse;
import com.apiverve.chinesezodiac.APIException;

// Initialize the client
ChineseZodiacAPIClient client = new ChineseZodiacAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("date", "1990-01-15");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/chinesezodiac](https://docs.apiverve.com/ref/chinesezodiac)
...
- **Documentation:** [https://docs.apiverve.com/ref/chinesezodiac](https://docs.apiverve.com/ref/chinesezodiac)
- **Issues:** [GitHub Issues](https://github.com/apiverve/chinesezodiac-api/issues)
